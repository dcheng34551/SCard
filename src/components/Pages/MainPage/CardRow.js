...
const CardsRow = (props) => {
  ...
  return (
    <>
      <RowContainer>
        <RowTitle>
          <RowTitleIcon src={props.type === "myCard" ? cards : recCards} />
        ...
        {props.type === "myCard" && JSON.stringify(imgArr) !== "[]" ? (
          <Swiper
            ...
            style={size.width >= 768 ? swiperStyle : smallSwiperStyle}
            navigation={true}
            mousewheel={true}
            pagination={true}
          ...
          >
            {imgArr.map((img) => (
              ...
              >
                ...
                >
                  {onHover && onHoverCard === img.basicSetting.id ? (
                    <CardDetails
                      onClick={() => {
                  ...
                  showCardDetails ? (
                    <CardDetailsBoard>
                      <CardDetailsBoardBtn onClick={openModal}>
                        <WhiteBtn src={viewIcon} />
                        預覽
                      </CardDetailsBoardBtn>
                      <CardDetailsBoardBtn
                        onClick={() => {
                          handleDeleteCard(onHoverCard);
                        }}
                      >
                  ...
                  <CardImg
                    data-id={img.basicSetting.id}
                    key={img.snapshot}
                    src={img.snapshot ? img.snapshot : img.default}
                    onClick={handleEditExistCard}
                  ></CardImg>
          ...
          <>
            <NoCardRow>
              <NoCardRowText>創造一張屬於你的卡片吧</NoCardRowText>
            ...
            {sampleImgArr.map((img) => (
              ...
              >
                ...
                >
                  ...
                  onHoverCard === img.basicSetting.id &&
                  showCardDetails ? (
                    <CardDetailsBoard style={{ height: "30px" }}>
                      <CardDetailsBoardBtn onClick={openModal}>
                        <WhiteBtn src={viewIcon} />
                        預覽
                      </CardDetailsBoardBtn>
