...
const SendForm = (props) => {
  ...
  return (
    <MainSendingForm onSubmit={handleSendMail}>
      ...
      <InputContainer>
        <MainSendingFormLabel htmlFor="select">選擇卡片:</MainSendingFormLabel>
        ...
        >
          {options.map((option) => (
            <option value={option.basicSetting.id} key={option.basicSetting.id}>
              {option.cardName ? option.cardName : option.basicSetting.id}
            </option>
          ))}
        </MainSendingCardSelect>
      </InputContainer>
      <InputContainer>
        <MainSendingFormLabel htmlFor="email">郵箱地址:</MainSendingFormLabel>
      ...
      <InputContainer>
        <MainSendingFormLabel htmlFor="recipient">收件人:</MainSendingFormLabel>
        <MainSendingFormInput
          placeholder="收件人稱呼"
          id="recipient"
          onChange={(e) => {
      ...
      <InputContainer>
        <MainSendingFormLabel htmlFor="sender">寄件人:</MainSendingFormLabel>
        <MainSendingFormInput
          placeholder="寄件人稱呼"
          id="sender"
          onChange={(e) => {
          ...
          {selectedCard !== "" ? (
            ...
            >
              <Cover cardOpend={cardOpend}>
                <RightContent snapshot={leftInnerSnapshot}></RightContent>
                <LeftContent snapshot={coverSnapshot}></LeftContent>
              </Cover>
            </Card>
          ) : (
            <PreviewAreaEmtpyWarning>請先選擇卡片</PreviewAreaEmtpyWarning>
          )}
        </PreviewArea>
      </PreviewContainer>
